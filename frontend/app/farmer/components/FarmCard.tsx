...
export function FarmCard({ farm, onDelete, onEdit }: Props) {
  ...
  return (
    <div className="bg-white border border-[#E4DFD4] rounded-xl p-4">
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          <span
            className="w-3 h-3 rounded-sm flex-shrink-0"
            style={{ background: farm.color || '#22c55e' }}
          />
      ...
      <dl className="mt-3 grid grid-cols-2 gap-2 text-xs">
        <div>
          <dt className="text-stone-400">Crop</dt>
        ...
        <div className="col-span-2">
          <dt className="text-stone-400">Sowing</dt>
          <dd className="text-stone-700">{farm.sowing_date || '—'}</dd>
        </div>
      </dl>

      {editing && (
        <div className="mt-3 space-y-2 border-t border-[#E4DFD4] pt-3">
          <input
            className="w-full bg-white border border-[#E4DFD4] rounded px-2 py-1.5 text-xs text-stone-800"
      ...
      {expanded && (
        <div className="mt-3 border-t border-[#E4DFD4] pt-3 space-y-2">
          ...
          <pre className="text-[10px] font-mono text-stone-500 max-h-28 overflow-y-auto bg-[#F5F2EB] rounded p-2 border border-[#E4DFD4]">
