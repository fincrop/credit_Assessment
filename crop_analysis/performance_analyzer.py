...
class CropPerformanceAnalyzer:
    ...
    def analyze_performance(
        ...
        logger.info("  Average Yield Potential:%.1f%%", avg_yield)
    ...
    # =========================================================================
    # PATH B â€” ENHANCED HEALTH SCORE  (crop-agnostic, 0â€“100)
    # =========================================================================
    ...
    def _enhanced_health_score(
        ...
        anomaly_events = self._detect_index_anomalies(eval_cvi, eval_ndvi, dates, n)
    ...
    def _enhanced_yield_potential(
        ...
        total_yield = round(min(100.0, max(0.0,
    ...
    def _estimate_yield_potential(
        ...
        ndvi_values = self._chronological_ndvi(scenes)
        if not ndvi_values:
            return 50.0, {'cumulative_ndvi': 0.0, 'note': 'No NDVI data'}
